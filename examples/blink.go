...
func main() {
    ...
    lightOn, _ := lwgo.NewMessage([]byte{0x9,0xf,0x3,0x1,0x5,0x9,0x3,0x0,0x1,0x2}, 2, time.Millisecond * 500) // dim to max
    //lightOn, _ := lwgo.NewMessage([]byte{0x0,0x0,0x3,0x1,0x5,0x9,0x3,0x0,0x1,0x2}) // switch on (to last level)
    lightOff, _ := lwgo.NewMessage([]byte{0x4,0x0,0x3,0x0,0x5,0x9,0x3,0x0,0x1,0x2}, 0, 0) // off
